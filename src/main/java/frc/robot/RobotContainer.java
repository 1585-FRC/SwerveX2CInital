...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
                ...
                drivetrain
                        .applyRequest(() -> drive.withVelocityX(-applyJoystickDeadzone(joystick.getLeftY()) * MaxSpeed) // Drive
                                                                                                                        // forward
                                                                                                                        // with
                                                                                                                        // negative
                                                                                                                        // Y
                                                                                                                        // (forward)
                                .withVelocityY(-applyJoystickDeadzone(joystick.getLeftX()) * MaxSpeed) // Drive left
                                                                                                       // with negative
                                                                                                       // X (left)
                                .withRotationalRate(-applyJoystickDeadzone(joystick.getRightX()) * MaxAngularRate) // Drive
                                                                                                                   // counterclockwise
                                                                                                                   // with
                                                                                                                   // negative
                                                                                                                   // X

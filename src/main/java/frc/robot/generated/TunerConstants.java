...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(90).withKI(0).withKD(0.7)
        .withKS(0).withKV(1.4).withKA(0)
    ...
    public static final CANBus kCANBus = new CANBus("drive system", "./logs/example.hoot");
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.349609375);
    ...
    private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.236328125);
